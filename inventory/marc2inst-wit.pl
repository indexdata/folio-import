...
sub getRules {
  ...
  # the 4 lines below fix the mapping rules change for Poppy
  my $s20 = '[{"entity":[{"rules":[{"conditions":[{"type":"set_identifier_type_id_by_name","parameter":{"name":"ISBN"}}]}],"target":"identifiers.identifierTypeId","subfield":["a"],"description":"Type for Valid ISBN"},{"rules":[{"conditions":[{"type":"remove_ending_punc, trim"}]}],"target":"identifiers.value","subfield":["a","c","q"],"description":"Valid ISBN","requiredSubfield":["a"],"applyRulesOnConcatenatedData":true}]},{"entity":[{"rules":[{"conditions":[{"type":"set_identifier_type_id_by_name","parameter":{"name":"Invalid ISBN"}}]}],"target":"identifiers.identifierTypeId","subfield":["z"],"description":"Type for Invalid ISBN"},{"rules":[{"conditions":[{"type":"remove_ending_punc, trim"}]}],"target":"identifiers.value","subfield":["z","q","c"],"description":"Invalid ISBN","requiredSubfield":["z"],"applyRulesOnConcatenatedData":true}]}]';
