/*
  This script will take a file of holdings and a file items and match on holdingsRecordId.
  Then it will iterate thru the items and compare the holdings call number to effective item callnumber.
*/
