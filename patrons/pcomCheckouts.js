...
const lib2sp = {
  "17": "PA - Circulation Desk",
  "47": "GA - Circulation Desk",
  "66": "SGA - Circulation Desk",
  "57": "ILL"
};
...
(async () => {
  try {
    if (!circFile) {
      throw('Usage: node pcomCheckouts.js <circ_file_csv>');
    }
